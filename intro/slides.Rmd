...
- Download: [https://github.com/jensroes/edge-hill-r-workshop](https://github.com/jensroes/edge-hill-r-workshop)
- Click on: `Code` \> `Download ZIP` \> unzip directory on your machine.
- Open project by double clicking on `ljm-r-workshop.Rproj`
- `data-viz/exercises/`: exercises associated with each topic
- `data-viz/slides.Rmd`: these slides in R markdown format (`.html` format provided as well)
